...
```yaml
identity:
  name: Saksham Shekher (OshekharO)
  role: Developer, Data Enthusiast & AI Explorer
  location: India 🇮🇳
  education: Computer Science Student 🎓

passion:
  - Crafting interactive & responsive web experiences 🌐
  - Building Python-powered automation & analytics tools 🐍
  - Exploring GPT models, AI agents & LLM integrations 🤖
  - Designing intelligent web indexers & search tools 🔍

current_focus:
  - Scalable API Architecture & Microservices 🏗️
  - Advanced Data Analytics & Predictive Modeling 📊
  - Cloud Deployments & Serverless Workflows ☁️
```
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/OpenAI_GPT-412991?style=for-the-badge&logo=openai&logoColor=white" alt="GPT-4"/>
  <img src="https://img.shields.io/badge/Data_Analytics-008080?style=for-the-badge&logo=pandas&logoColor=white" alt="Data Analytics"/>
  <img src="https://img.shields.io/badge/Web_Indexing-FF6F00?style=for-the-badge&logo=google&logoColor=white" alt="Web Indexing"/>
  <img src="https://img.shields.io/badge/REST_APIs-0055FF?style=for-the-badge&logo=postman&logoColor=white" alt="APIs"/>
</p>
